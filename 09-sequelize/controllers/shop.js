...
exports.getProduct = (req, res, next) => {
  ...
  // findAll always gives multiple items even through it's
...
exports.postOrder = (req, res, next) => {
  ...
  req.user
    ...
    .then((cart) => {
      fetchedCart = cart;
      return cart.getProducts(); // get products in that cart
    })
    .then((products) => {
      return req.user
        .createOrder()
        .then((order) => {
          order.addProducts(
            products.map((product) => {
              // table name in sequelize.define()
              // gets quantity for cart and store in order
